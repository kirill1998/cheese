<?php
namespace Accord\Api\UrlRewrite\DbStorage;

/**
 * Interceptor class for @see \Accord\Api\UrlRewrite\DbStorage
 */
class Interceptor extends \Accord\Api\UrlRewrite\DbStorage implements \Magento\Framework\Interception\InterceptorInterface
{
