<?php
namespace Accord\Checkout\Model\Cart;

/**
 * Interceptor class for @see \Accord\Checkout\Model\Cart
 */
class Interceptor extends \Accord\Checkout\Model\Cart implements \Magento\Framework\Interception\InterceptorInterface
{
