...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accord_Checkout/billing-address'
            },
            ...
            isBillingAddressDetailsVisibleToGuest: function() {
                return ko.computed(function () {
                    if (customer.isLoggedIn()) {
                        return true;
                    }
                    return !this.isAddressSameAsShipping() && this.isBillingAddressSelected();
                }, this)
            },
